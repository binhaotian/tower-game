...
static constexpr auto qt_meta_stringdata_ZN9HealthBarE = QtMocHelpers::stringData(
    "HealthBar"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9HealthBarE[] = {
...
Q_CONSTINIT const QMetaObject HealthBar::staticMetaObject = { {
    QMetaObject::SuperData::link<Follower::staticMetaObject>(),
    qt_meta_stringdata_ZN9HealthBarE.offsetsAndSizes,
    qt_meta_data_ZN9HealthBarE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9HealthBarE_t,
        // Q_OBJECT / Q_GADGET
...
void *HealthBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9HealthBarE.stringdata0))
        return static_cast<void*>(this);
    return Follower::qt_metacast(_clname);
}

int HealthBar::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = Follower::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
